...
const contractAddress = "0xab053b1C856fc65a8C2f1a1b0acce679741a0Ab2";
const abi = [
  {
...
async function signIn() {
  ...
  var noErrors = true;
  try {
    await contract.signProposal(parseHexArray(proofs));
  } catch {
    noErrors = false;
  } finally {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3 style={{ marginBottom: "20px" }}>Sign Proposal</h3>
          <TextArea
            showCount
            id="proof2"
            placeholder="proofs"
